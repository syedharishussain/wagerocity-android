...
public class GamesListAdapter extends BaseAdapter {
    ...
    public View getView (final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.cbPSA.setOnCheckedChangeListener( new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged (CompoundButton buttonView, boolean isChecked) {

                markCheck( isChecked, game, new OddHolder(
                        0.0,
                        game.getTeamANumber(),
                        ...
                        true,
                        game.getPoolCredits()
                ), game.getTeamANumber(), game.getTeamAOdd().getId(), POINT_SPREAD, game.getOddHolders() );
            }

        } );

        viewHolder.cbPSB.setOnCheckedChangeListener( new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged (CompoundButton buttonView, boolean isChecked) {
                markCheck( isChecked, game, new OddHolder(
                        0.0,
                        ...
                        false,
                        game.getPoolCredits()
                ), game.getTeamBNumber(), game.getTeamBOdd().getId(), POINT_SPREAD, game.getOddHolders() );
            }
        } );
        ...
        viewHolder.cbMLA.setOnCheckedChangeListener( new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged (CompoundButton buttonView, boolean isChecked) {
                markCheck( isChecked, game, new OddHolder(
                        ...
                        true,
                        game.getPoolCredits()
                ), game.getTeamANumber(), game.getTeamAOdd().getId(), MONEY_LINE, game.getOddHolders() );
            }
        } );
        ...
        viewHolder.cbMLB.setOnCheckedChangeListener( new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged (CompoundButton buttonView, boolean isChecked) {
                markCheck( isChecked, game, new OddHolder(
                        ...
                        false,
                        game.getPoolCredits()
                ), game.getTeamBNumber(), game.getTeamBOdd().getId(), MONEY_LINE, game.getOddHolders() );
            }
        } );
        ...
        viewHolder.cbOA.setOnCheckedChangeListener( new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged (CompoundButton buttonView, boolean isChecked) {
                markCheck( isChecked, game, new OddHolder(
                        ...
                        true,
                        game.getPoolCredits()
                ), game.getTeamANumber(), game.getTeamAOdd().getId(), OVER, game.getOddHolders() );
            }
        } );
        ...
        viewHolder.cbUA.setOnCheckedChangeListener( new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged (CompoundButton buttonView, boolean isChecked) {
                markCheck( isChecked, game, new OddHolder(
                        ...
                        false,
                        game.getPoolCredits()
                ), game.getTeamANumber(), game.getTeamAOdd().getId(), UNDER, game.getOddHolders() );
            }
        } );
...
//        }
    ...
    private void markCheck (boolean isChecked, Game game, OddHolder object, String teamANumber, String id, String pointSpread, ArrayList<OddHolder> oddHolders2) {
        if (isChecked) {
            ...
            game.getOddHolders()
                    .add( //(Double stake, String teamId, String oddId, String teamName, String teamVsteam, String oddValue, String betTypeSPT, String betOT, String betTypeString, String pointSpreadString)
                            object );
        } else {
            if (game.getOddHolders() != null) {
                if (game.getOddHolders().size() > 0) { removeObject( teamANumber, id, pointSpread, oddHolders2 ); }
            }
        }
    }
    ...
    private void setBettingInfo(Game game, ViewHolder view) {
        ...
        if (game.getTeamAOdd() != null) {
            ...
            else { view.cbPSA.setEnabled( false ); }
        ...
        if (game.getTeamBOdd() != null) {
            ...
            else { view.cbPSB.setEnabled( false ); }
    ...
    void removeObject (String teamId, String oddId, String betTypeString, ArrayList<OddHolder> oddHolders) {
        ...
        for (int i = 0; i < oddHolders.size(); i++) {
            ...
            if (oddHolder.getOddId().equals( oddId ) && oddHolder.getTeamId().equals( teamId ) && oddHolder
                    .getBetTypeString().equals( betTypeString )) {
